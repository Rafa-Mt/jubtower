...
gameMap.makeMap(25, roomMinSize, roomMaxSize, width, height, 0.5);
...
const player = new Entity(
  foregroundCtx,
  gameMap.spawnpoint.x,
  gameMap.spawnpoint.y,
  tileSize,
  tileSize,
  "player",
  MapTiles[TextTiles.player].path,
  tileSize,
  tileSize,
  newLevel,
  gameOver,
...
async function newLevel() {
  ...
  await gameMap.makeMap(
    25,
    roomMinSize,
    roomMaxSize,
    width,
    height,
    0.5 + window.globalDifficulty
  );
...
overlayCtx.fillText(
  "By: Jose Carrillo, Rafael Mata, Tomas Santana y Marlon Urdaneta.",
  0,
  470
);
